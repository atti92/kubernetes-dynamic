...
class InClusterConfigLoader(object):
    def __init__(self, token_filename, cert_filename, try_refresh_token=True, environ=os.environ):
...
def load_incluster_config(client_configuration=None, try_refresh_token=True):
    ...
    InClusterConfigLoader(
        token_filename=SERVICE_TOKEN_FILENAME, cert_filename=SERVICE_CERT_FILENAME, try_refresh_token=try_refresh_token
